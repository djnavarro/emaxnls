...
- **Use UK English spelling** in all code comments, roxygen documentation, vignettes, and
  other prose (e.g. "behaviour" not "behavior", "colour" not "color", "modelling" not
  "modeling", "optimisation" not "optimization")
